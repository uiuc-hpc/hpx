...
namespace hpx { namespace cds {
    template <>
    std::atomic<std::size_t> hazard_pointer_wrapper<
        ::cds::gc::hp::details::HPXTLSManager>::max_concurrent_attach_thread_{
        100};

    template <>
    std::atomic<std::size_t>
        hazard_pointer_wrapper<::cds::gc::hp::details::DefaultTLSManager>::
            max_concurrent_attach_thread_{100};
