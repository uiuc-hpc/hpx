...
Note that the |hpx| lci futurization wrapper should work with *any* asynchronous
...
parameters that are supplied by template instantiations inside the `hpx::lci` code.

See the :ref:`API reference <modules_lci_api>` of this module for more
details.
